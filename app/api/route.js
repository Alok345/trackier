...
export async function GET(request) {
  ...
  console.log('🎯 ROOT API Route Called - Params:', { forceTransparent, clickId })
  ...
  try {
    ...
    console.log('✅ Click tracked successfully - updating Firestore')
    ...
    // Perform the redirect with 302 status
